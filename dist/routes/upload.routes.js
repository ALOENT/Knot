...
const sensitiveRateLimiter = (0, express_rate_limit_1.default)({
    windowMs: 15 * 60 * 1000,
    max: 10,
    message: { success: false, message: 'Too many upload requests. Please try again later.' },
});
router.post('/', auth_middleware_1.protect, sensitiveRateLimiter, upload.single('file'), upload_controller_1.uploadFile);
